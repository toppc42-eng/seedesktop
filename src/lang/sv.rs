...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till SeeDesktop..."),
        ...
        ("install_tip", "På grund av UAC, kan inte SeeDesktop fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera SeeDesktop på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge SeeDesktop \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge SeeDesktop \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [SeeDesktop Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep SeeDesktop background service", "Behåll SeeDesktop i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa SeeDesktop programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show SeeDesktop", "Visa SeeDesktop"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),

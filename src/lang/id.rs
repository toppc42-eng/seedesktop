...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke SeeDesktop..."),
        ...
        ("install_tip", "Karena UAC, SeeDesktop tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal SeeDesktop ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk SeeDesktop."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk SeeDesktop."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd SeeDesktop untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input SeeDesktop]."),
        ...
        ("Language", "Bahasa"),
        ("Keep SeeDesktop background service", "Pertahankan SeeDesktop berjalan pada service background"),
        ...
        ("Show SeeDesktop", "Tampilkan SeeDesktop"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada SeeDesktop"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada SeeDesktop"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC SeeDesktop yang sedang berjalan"),
        ...
        ("verify_rustdesk_password_tip", "Verifikasi Kata Sandi SeeDesktop"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan SeeDesktop, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Silahkan perbarui SeeDesktop Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah SeeDesktop berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh SeeDesktop"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela SeeDesktop sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service SeeDesktop agar tetap aktif"),
        ...
        ("About SeeDesktop", "Tentang SeeDesktop"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Silahkan perbarui aplikasi SeeDesktop ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "SeeDesktopi võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa SeeDesktop mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et SeeDesktop oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb SeeDesktopile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb SeeDesktopile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma SeeDesktopile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [SeeDesktop Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep SeeDesktop background service", "Säilita SeeDesktopi taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele SeeDesktopi rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show SeeDesktop", "Kuva SeeDesktop"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma SeeDesktopile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma SeeDesktopile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud SeeDesktopi kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita SeeDesktopi parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul SeeDesktopi kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda SeeDesktop Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib SeeDesktopil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb SeeDesktopil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui SeeDesktopi aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada SeeDesktopi taustateenust."),
        ...
        ("About SeeDesktop", "SeeDesktopi teave"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage SeeDesktopi klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),

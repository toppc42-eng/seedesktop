...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään SeeDesktop verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa SeeDesktop ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi SeeDesktopin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava SeeDesktopille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava SeeDesktopille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten SeeDesktop daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota SeeDesktopille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli SeeDesktop ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "SeeDesktop palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa SeeDesktopin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "SeeDesktop palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep SeeDesktop background service", "Pidä SeeDesktopin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista SeeDesktopin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show SeeDesktop", "Näytä SeeDesktop"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista SeeDesktop salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "SeeDesktop ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä SeeDesktop Server Pro versioon {} jatkaaksesi."),
        ...
        ("About SeeDesktop", "Tietoa SeeDesktopistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-SeeDesktop-asiakasversioon {} yhteensopivuuden takaamiseksi"),

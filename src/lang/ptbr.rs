...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do SeeDesktop..."),
        ...
        ("install_tip", "Devido ao UAC, o SeeDesktop não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o SeeDesktop no sistema."),
        ("Click to upgrade", "Clique para fazer o upgrade"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao SeeDesktop permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao SeeDesktop permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o SeeDesktop use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [SeeDesktop Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep SeeDesktop background service", "Manter o serviço do SeeDesktop executando em segundo plano"),
        ...
        ("Show SeeDesktop", "Exibir SeeDesktop"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do SeeDesktop."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do SeeDesktop."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do SeeDesktop."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do SeeDesktop"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o SeeDesktop e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o SeeDesktop Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o SeeDesktop funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por SeeDesktop"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do SeeDesktop estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço SeeDesktop em segundo plano"),
        ...
        ("About SeeDesktop", "Sobre SeeDesktop"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente SeeDesktop para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o SeeDesktop verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o SeeDesktop ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o SeeDesktop não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor SeeDesktop OSS não inclui este recurso."),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til SeeDesktop-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan SeeDesktop ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere SeeDesktop på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give SeeDesktop \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give SeeDesktop \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give SeeDesktop mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [SeeDesktop Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep SeeDesktop background service", "Behold SeeDesktop baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn SeeDesktop appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("Show SeeDesktop", "Vis SeeDesktop"),
        ("This PC", "Denne PC"),
        ("or", "eller"),
        ("Elevate", "Elevér"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open-source driveren, og aktivere software rendering. Et genstart af SeeDesktop er nødvendigt."),
        ...
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give SeeDesktop rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC vinduet ved kørsel af SeeDesktop."),
        ...
        ("verify_rustdesk_password_tip", "Bekræft SeeDesktop adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge SeeDesktop til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Opgradér venligst SeeDesktop Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre SeeDesktop i at køre normalt."),
        ...
        ("powered_by_me", "Drives af SeeDesktop"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af SeeDesktop med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis SeeDesktop vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper på at SeeDesktop baggrundstjenesten kører"),
        ...
        ("About SeeDesktop", "Om SeeDesktop"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Opgrader venligst SeeDesktop-klienten til version {} eller nyere på fjernsiden!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem SeeDesktop..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, SeeDesktop v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate SeeDesktopu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate SeeDesktopu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno SeeDesktopu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »SeeDesktop Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep SeeDesktop background service", "Ohrani SeeDesktopovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije SeeDesktop, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "SeeDesktop potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "SeeDesktop potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za SeeDesktop"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite SeeDesktop, prekinite klic in program zaprite."),
        ("scam_text2", "SeeDesktop omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite SeeDesktop Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo SeeDesktop"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno SeeDesktopa odprto"),
        ...
        ("floating_window_tip", "Pomaga pri SeeDesktop storitvi v ozadju"),
        ...
        ("About SeeDesktop", "O SeeDesktopu"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite SeeDesktop odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),

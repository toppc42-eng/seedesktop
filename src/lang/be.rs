...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Падключэнне да сеткі SeeDesktop..."),
        ...
        ("install_tip", "У некаторых выпадках SeeDesktop можа працаваць няправільна на аддаленым вузле з-за UAC. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўстаноўкі SeeDesktop у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам неабходна дазволіць SeeDesktop правы доступу."),
        ("config_screen", "Для аддаленага доступу да працоўнага сталу вам неабходна дазволіць SeeDesktop правы здымку экрана."),
        ...
        ("android_input_permission_tip1", "Каб аддалёная прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, неабходна дазволіць SeeDesktop выкарыстоўваць паслугу \"Асаблівыя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і ўступіце ў \"Устаноўленыя паслугі\", уключыце паслугу \"SeeDesktop Input\"."),
        ...
        ("Language", "Мова"),
        ("Keep SeeDesktop background service", "Захаваць фонавую службу SeeDesktop"),
        ...
        ("Show SeeDesktop", "Паказаць SeeDesktop"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, неабходна дазволіць SeeDesktop маніторынг уводу."),
        ("config_microphone", "Каб размаўляць з аддаленай старонкай, неабходна дазволіць SeeDesktop запіс аўдыё."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб аддалены карыстальнік націснуў \"OK\" ў акне UAC пры запуску SeeDesktop."),
        ...
        ("verify_rustdesk_password_tip", "Пацвердзіць пароль SeeDesktop"),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсці, каго вы НЕ ВЕДАЕЦЕ і каму НЕ ДАВЕРАЕЦЕ, і ён просіць вас выкарыстаць SeeDesktop і запусціць яго службу, не працягвайце і неадкладна адмяніце размову."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Абнавіце SeeDesktop Server Pro да версіі {} або новейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа перашкаджаць правільнай працы SeeDesktop на кіруючым баку."),
        ...
        ("powered_by_me", "На аснове SeeDesktop"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць толькі падключэнне пры адкрытым акне SeeDesktop"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу SeeDesktop"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Калі ласка, абнавіце кліент SeeDesktop да версіі {} або навейшай на аддаленым баку!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới SeeDesktop..."),
        ...
        ("install_tip", "Do cơ chế UAC, SeeDesktop có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt SeeDesktop vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho SeeDesktop."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho SeeDesktop."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [SeeDesktop Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep SeeDesktop background service", "Giữ dịch vụ SeeDesktop chạy nền"),
        ...
        ("Show SeeDesktop", "Hiện SeeDesktop"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu SeeDesktop"),
        ...
        ("scam_text2", "Chỉ sử dụng SeeDesktop với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ SeeDesktop mở"),
        ...
        ("floating_window_tip", "Giữ SeeDesktop trên cùng"),
        ...
        ("About SeeDesktop", "Về SeeDesktop"),

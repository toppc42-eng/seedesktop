...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip1", "SeeDesktop இந்த Android சாதனத்தை கட்டுப்படுத்த \"அணுகல் சேவைகள்\" அனுமதி தேவை."),
        ("android_input_permission_tip2", "சிஸ்டம் அமைப்புகளில் [நிறுவப்பட்ட சேவைகள்] கண்டுபிடித்து, SeeDesktop சேவை இயக்கவும்."),
        ...
        ("Language", "மொழி"),
        ("Keep SeeDesktop background service", "SeeDesktop பின்புல சேவையை வைத்திரு"),
        ("Ignore Battery Optimizations", "பேட்டரி மேம்படுத்தல்களை புறக்கணி"),
        ("android_open_battery_optimizations_tip", "SeeDesktop க்கு பேட்டரி மேம்படுத்தல் அணைக்க அமைப்புகளுக்கு செல்லவும்"),
        ...
        ("Show SeeDesktop", "SeeDesktop ஐ காட்டு"),
        ("This PC", "இந்த PC"),
        ("or", "அல்லது"),
        ("Elevate", "உயர்த்து"),
        ...
        ("scam_text2", "SeeDesktop ஊழியர் இவ்வாறு தொடர்பு கொள்ள மாட்டார்கள்"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "SeeDesktop Server Pro {} க்கு மேம்படுத்து"),
        ...
        ("selinux_tip", "SELinux இயக்கப்பட்டது, SeeDesktop அனுமதி வேண்டும்"),
        ...
        ("enable-2fa-desc", "SeeDesktop இரு காரணி அங்கீகாரம் ஆதரிக்கிறது"),

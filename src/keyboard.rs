...
pub mod input_source {
    ...
    pub fn get_cur_session_input_source() -> String {
        ...
        #[cfg(target_os = "windows")]
        {
            // On Windows, Input source 2 is more reliable for keyboard typing
            // across apps/UAC contexts, so prefer it by default.
            if input_source.is_empty() || input_source == CONFIG_INPUT_SOURCE_1 {
                return CONFIG_INPUT_SOURCE_2.to_string();
            }
        }

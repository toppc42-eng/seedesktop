...
class InputModel {
  ...
  InputModel(this.parent) {
    ...
    // User preference: whether to sync Num Lock state to remote.
    _syncNumLock = bind.mainGetUserDefaultOption(key: kKeySyncNumLock) != 'N';
  }
  ...
  void setSyncNumLock(bool enabled) {
    _syncNumLock = enabled;
  }
  ...
  void enterOrLeave(bool enter) {
    ...
    _flingTimer?.cancel();
    // Always send leave(false) to rust as a safety release path.
    // This prevents rare stuck global-keyboard states if grab mode was active.
    if (!isInputSourceFlutter || !enter) {

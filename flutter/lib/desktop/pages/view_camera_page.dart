...
class _ViewCameraPageState extends State<ViewCameraPage>
  ...
  void leaveView(PointerExitEvent evt) {
    if (_ffi.canvasModel.viewStyle.style != kRemoteViewStyleStretch && _ffi.ffiModel.keyboard) {
...
class _ImagePaintState extends State<ImagePaint> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!isViewStretch() && c.imageOverflow.isTrue && c.scrollStyle != ScrollStyle.scrollauto) {

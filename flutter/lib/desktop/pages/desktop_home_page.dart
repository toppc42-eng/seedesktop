...
import 'package:flutter_hbb/desktop/widgets/main_menu_localized.dart';
...
class _DesktopHomePageState extends State<DesktopHomePage>
          ...
          Column(
            children: [
              ...
              if (bind.mainGetBuildinOption(key: "hide-powered-by-me") != 'Y')
                Center(child: loadPowered(context)).marginOnly(bottom: 3),
            ],
          ),
        ],
      ),
  ...
  Widget buildLeftPane(BuildContext context) {
    ...
    final children = <Widget>[
      ...
      buildTip(context),
      if (!isOutgoingOnly && isIncomingOnly) buildIDBoard(context),
    ...
    rustDeskWinManager.setMethodHandler((call, fromWindowId) async {
      ...
      if (call.method == kWindowMainWindowOnTop) {
        ...
        try {
          ...
          const skip = {
            kTabLabelHomePage,
            kTabLabelFavoritesPage,
            kTabLabelSettingPage,
            kTabLabelSavedConnectionsPage,
          };
          return tabController.state.value.tabs
              .where((t) => !skip.contains(t.key))
              .map((e) => e.key)
              .join(',');
        } catch (e) {
          debugPrint('get_remote_list on main: $e');
          return '';
        }
      }
    });

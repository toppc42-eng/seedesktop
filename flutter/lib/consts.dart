...
/// Main window: hide/close a sub-window by id (Linux sub-engines lack multi_window channel).
const String kWindowEventCloseSubWindow = "close_sub_window";
...
/// Silent OTA: local time for daily check (`H:M` or `HH:MM`, 24h). Empty → 16:00.
const String kOptionOtaSilentDailyTime = "ota-silent-daily-time";

/// `Y` / `N` — run the daily silent install check at `ota-silent-daily-time`.
const String kOptionOtaSilentDailyEnabled = "ota-silent-daily-enabled";
...
const String kBrandedAppName = "SeeDesktop";
...
const String kKeySyncNumLock = "sync_num_lock";
...
/// [kRemoteViewStyleStretch] Fill local canvas edge-to-edge (may crop).
const kRemoteViewStyleStretch = 'stretch';
